library gridhub.src.components.issue_pane;
    ...
    issues.forEach((issue) {
      listItems.add(
        IssueListItem({
          'repo': repo,
          'issue': issue,
          'pullRequest': repo.pullRequestsMap[issue['number']],
          'key': 'issue-list-item-#${issue['number']}'
        })
      );
    });
